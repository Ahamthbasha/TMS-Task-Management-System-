// // hooks/useCommentQueries.ts - FULLY RESOLVED
...
// import type { IFile } from '@/types/interface/fileInterface';
// import { createCommentWithFiles as createCommentWithFilesApi } from '../api/userAction/userAction';
...
// /**
//  * Hook to fetch all comments for a task
//  */
...
//     gcTime: 1000 * 60 * 10, // 10 minutes (React Query v4+)
//   });
// };
...
//   return useMutation<
//     CommentApiResponse<IComment & { files?: IFile[] }>, 
//     AxiosErrorResponse, 
...
// hooks/useCommentQueries.ts - CORRECTED
import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query';
import {
  createComment,
  getCommentsByTaskId,
...
/**
 * Hook to create a new comment with files
 */
export const useCreateCommentWithFiles = () => {
  const queryClient = useQueryClient();
